...
class PayrollControllerFunctionalTest extends PlaywrightTestBase {
    ...
    @Nested
    @DisplayName("Payroll List")
    class PayrollListTests {
    ...
    @Nested
    @DisplayName("New Payroll Form")
    class NewPayrollFormTests {
    ...
    @Nested
    @DisplayName("Payroll Detail")
    class PayrollDetailTests {
    ...
    @Nested
    @DisplayName("Payroll Actions")
    class PayrollActionsTests {
    ...
    @Nested
    @DisplayName("Payroll Reports")
    class PayrollReportsTests {
    ...
    @Nested
    @DisplayName("Bukti Potong 1721-A1")
    class BuktiPotongTests {
