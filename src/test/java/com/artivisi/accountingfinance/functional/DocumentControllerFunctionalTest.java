...
class DocumentControllerFunctionalTest extends PlaywrightTestBase {
    ...
    @Nested
    @DisplayName("Transaction Documents")
    class TransactionDocumentTests {
    ...
    @Nested
    @DisplayName("Document View and Download")
    class DocumentViewDownloadTests {
    ...
    @Nested
    @DisplayName("Document Integration with Transaction Form")
