-- V851: Security Test Transactions
-- Transactions with different states for security regression tests
-- ID Convention: a0=Security/Auth test transactions
...
VALUES (
    'a0000000-0000-0000-1000-000000000001',
    'JE-TEST-0001',
    'a0000000-0000-0000-0000-000000000002',
...
INSERT INTO journal_entries (id, journal_number, id_transaction, id_account, debit_amount, credit_amount, posted_at, created_at, updated_at)
VALUES (
    'a0000000-0000-0000-1000-000000000002',
    'JE-TEST-0001',
    'a0000000-0000-0000-0000-000000000002',
