...
-- ============================================
-- NOTE: Inventory templates (Pembelian/Penjualan/Penyesuaian Persediaan) are in
-- src/test/resources/db/migration/V004a__test_inventory_templates.sql
-- They are only loaded for tests, not in production, to keep the database clean
